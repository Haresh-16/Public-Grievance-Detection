...
class DataGenerator:
    ...
    def __init__(self,
        ...
        # Note that 
        #does not contain the actual image files themselves. This list is one of the outputs of the parser methods.
    ...
    def parse_xml(self,
                  ...
                  annotations_dirs=[],
                  classes=['background',
                           'open_manholes', 'proper_road', 
                           'proper_garbage', 'overflowing_garbage', 
                           'patchy_roads','proper_manholes'],
                  include_classes = 'all',
